...
interface ProductItem {
  ...
  href?: string; // ← opsional, isi kalau mau bisa diklik ke halaman tertentu
}

// ============================================================
// 1. PUSAT DATA PRODUK
// Untuk mengarahkan produk ke halaman tertentu, tambahkan href.
// Kalau tidak ada href, card tetap tampil tapi tidak bisa diklik.
// ============================================================
const allProducts = {
  cloudVps: {
    name: "Cloud VPS",
    ...
    badge: "HOT",
    href: "/cloud-vps", // ← arahkan ke halaman contoh
    icon: (
...
export function ProductMegaMenu({ onMouseEnter, onMouseLeave }: ProductMegaMenuProps) {
